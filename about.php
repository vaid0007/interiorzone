...
<html class="no-js" lang="zxx">
 ...
 <head>
    ...
    <!-- SEO -->
    <title>About Interior Zone | Interior Design & Construction Experts in Janakpuri East</title>
    ...
    <meta name="twitter:title" content="About Interior Zone" />
    <meta name="twitter:description"
        content="Trusted Interior Design, Architecture and Construction Company in Janakpuri East, New Delhi." />
    ...
    <script type="application/ld+json">
    {
      ...
      "@type":"AboutPage",
      "name":"About Interior Zone",
      "description":"Interior Zone is a leading Interior Design, Architecture and Construction company based in Janakpuri East, New Delhi.",
      "publisher":{
        "@type":"Organization",
        "name":"Interior Zone"
      }
                ...
                <div class="about-box-wrap">
                  <div class="about-box wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <div class="media-body">
                      ...
                      <p>
                        Seamless collaboration between architecture and real
                        estate teams for efficient project delivery.
                      </p>
                    </div>
                  </div>
    ...
    <div class="overflow-hidden space overflow-hidden" id="faq-sec">
      <div class="container">
        <div class="row gx-0 align-items-center flex-row-reverse">
          <div class="col-xl-6 mt-35 mt-xl-0">
            <div class="pe-xl-5 me-xl-5">
              <div class="title-area mb-40">
                <span class="sub-title text-anime">FAQ’S</span>
                <h2 class="sec-title style4 split-text">
                  Functional Architect Design Studios.
                </h2>
              </div>
              <div class="accordion-area accordion" id="faqAccordion3">
                ...
                <div
                  class="accordion-card active wow fadeInUp"
                  data-wow-delay=".3s"
                >
          ...
          <div class="col-xl-6">
            <div class="faq-image img-anim-left">
              <img src="assets/img/normal/faq-img2.png" alt="" />
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="testi-grid">
                  ...
                  <div class="box-content">
                    <p class="box-text">
                      ...
                      sustainable solutions. The result was a space that’s both
                      beautiful and highly functional. We couldn't be happier
                      with the outcome and the professionalism shown throughout
                      the process.
                    </p>
