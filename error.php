...
<html class="no-js" lang="zxx">
  <!-- Mirrored from html.themehour.net/faren/demo/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 May 2026 18:56:27 GMT -->
  <head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>Faren - Architecture & Interior Design Template - 404 Error</title>
      ...
      >
        <div class="container">
          <div class="breadcumb-content">
            <h1 class="breadcumb-title text-anime">404 Error</h1>
            <ul class="breadcumb-menu">
              <li class="wow fadeInUp" data-wow-delay=".2s">
                <a href="home-interior.html">Home</a>
              </li>
              <li class="wow fadeInUp" data-wow-delay=".3s">404 Error</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-xl-5">
            <div class="error-content">
              <h2 class="error-title text-theme">404</h2>
              <h2>PAGE NOT FOUND</h2>
              <p class="error-text">
                Oops! The page you’re looking for doesn’t exist
              </p>
              <a href="home-interior.html" class="th-btn th-black"
          ...
          <div class="col-xl-7">
            <div class="error-img">
              <img src="assets/img/theme-img/error.png" alt="404 image" />
            </div>
          </div>
        </div>
      </div>
